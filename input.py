...
def d15(tab, browser):
  ...
  phoneele = 'css=' + r'#ssf > div > div > div > div > div > div > div > div.signup-core > div.signin-layout__tab-content > div > form > div.signin-layout__form-inputs > div > div > div.xm-uikit-input.form-input.was-validated > div > input'
  sendele = 'css=' + r'#ssf > div > div > div > div > div > div > div > div.signup-core > div.signin-layout__tab-content > div > form > div.signin-layout__form-inputs > div > div > div.xm-uikit-input.verify-code-input.was-validated > div > div > div'
  target = 'phone='
  name = 'xmind'
...
def d16(tab, browser):
    ...
    tab.get(url)
    time.sleep(5)
    ele = tab.ele('css=#root > div > div > div.acss-1ni2mnl > div > div > div.acss-7b4lct > div.acss-lneci6 > div > div > div > button > span')
    ele.click()
    ele = tab.ele('css=#login-tabs > div:nth-child(2)')
    ele.click()
...
def e16(tab, browser):
  ...
  tab.get(url)
  ele = tab.ele('text=Start Chat')
  ele.click()
  ele = tab.ele(phoneele)
  ele.input(phonenum)
  ele = tab.ele('text=Send')
  tab.listen.start(targets=target)
  ele.click()
